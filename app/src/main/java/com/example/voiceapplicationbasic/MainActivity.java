package com.example.voiceapplicationbasic;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initalizeSpeechRecogniser();
    }

    private void initalizeSpeechRecogniser(){
    ...
    private void processResult(String command) {
        ...
        if (command.indexOf("what") != -1) {
            if (command.indexOf("your name") != -1) {
                speak("I'm Double Quote");
            }
            if (command.indexOf("time") != -1) {
                Date now = new Date();
                String time = DateUtils.formatDateTime(this, now.getTime(), DateUtils.FORMAT_ABBREV_ALL);
